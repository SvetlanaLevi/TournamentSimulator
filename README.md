...
To support dynamic comfiguration (custom team count or tournament format),
...
In case when 2 teams played absolutely equal whey would share the same posotion. I think this is a fair decision for a sports tournament, but it creates a problem when selecting qualified teams. For now I dont have a solution for this problem, but I would consider adding more tiebreaker rules or initiate a rematch for these teams.

PS: Please do not look at the code of the index.html file, it was AI generated for the convinience of testing and demonstration :)
